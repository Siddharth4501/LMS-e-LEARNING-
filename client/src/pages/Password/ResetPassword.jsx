  ...
  return (
    <HomeLayout>
      ...
      <div
        ...
        className="flex items-center justify-center h-[90vh] bg-gray-600"
      >
        {/* forget password card */}
        <form className="flex flex-col justify-center gap-6 rounded-lg p-4 text-white w-80 h-[26rem] shadow-[0_0_10px_black] bg-gray-800">
