...
const AddLectures = () => {
  ...
  return (
    <HomeLayout>
      <div className=" text-white flex flex-col items-center justify-center gap-10 min-h-[90vh] bg-gray-600">
        <div className="flex flex-col gap-5 p-2 shadow-[0_0_10px_black] w-96 rounded-lg bg-gray-800">
          ...
          <form onSubmit={handleFormSubmit} className="flex flex-col gap-3">
            ...
            <button className="bg-primary py-1 font-semibold text-lg">
              Add Lecture
            </button>
          </form>
        </div>
