...
const DisplayLectures = () => {
  ...
  return (
    <HomeLayout>
      <div className="flex flex-col gap-10 items-center justify-center min-h-[90vh] py-10 text-white bg-gray-600">
        {/* displaying the course name */}

        <h1 className="text-center text-2xl lg:p-0 py-5 font-semibold text-yellow-500">
          Course Name : {courseDetails?.title}
        </h1>

        <div className="lg:flex lg:flex-row flex-col align-center justify-center gap-10 lg:w-full w-auto">
          {/* left section for playing the video and displaying course details to admin */}
          <div className="space-y-5 w-[28rem] p-2 lg:m-0 my-5 max-w-[90vw] rounded-lg shadow-[0_0_10px_black] bg-gray-800">
            <video
          ...
          <ul className="w-[28rem] p-2 rounded-lg shadow-[0_0_10px_black] max-w-[90vw] space-y-4 bg-gray-800">
            <li className="font-semibold text-xl text-yellow-500 flex items-center justify-between">
              ...
              {role === "ADMIN" && (
                <button
                  ...
                  className="bg-emerald-600	 px-2 py-1 rounded-md font-semibold text-sm text-white"
                >
                  Add New Lecture
                </button>
              )}
                  ...
                  <li className="space-y-2" key={element._id}>
                    ...
                    {role === "ADMIN" && (
                      <button
                        ...
                        className="bg-primary px-2 py-1 rounded-md font-semibold text-sm"
                      >
                        Delete Lecture
                      </button>
                    )}
