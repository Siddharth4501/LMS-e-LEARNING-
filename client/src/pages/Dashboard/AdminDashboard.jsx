...
const AdminDashboard = () => {
  ...
  return (
    <HomeLayout>
      <div className="min-h-[90vh] pt-5 flex flex-col flex-wrap gap-10 text-white bg-gray-600">
        ...
        <div className="lg:grid lg:grid-cols-2 gap-5 m-auto max-w-[90vw]">
          {/* displaying the users chart and data */}
          <div className="flex flex-col items-center gap-10 p-5 shadow-lg rounded-md bg-gray-800 lg:my-0 my-10">
            {/* for displaying the pie chart */}
            <div className="w-80 max-w-[90vw] h-80">
              <Pie data={userData} />
            </div>
            ...
            <div className="grid grid-cols-2 gap-5">
              ...
              <div className="flex items-center justify-between py-5 sm:px-5 gap-5 rounded-md shadow-md ">
          ...
          <div className="flex flex-col items-center gap-10 p-5 shadow-lg rounded-md bg-gray-800">
            ...
            <div className="h-80 relative w-full">
              <Bar className="absolute bottom-0 h-80 sm:w-full max-w-[95vw]" data={salesData} />
            </div>
            ...
            <div className="grid grid-cols-2 gap-5">
              ...
              {/* card for enrolled users */}
              <div className="flex items-center justify-between sm:py-5 px-5 gap-5 rounded-md shadow-md">
                <div className="flex flex-col items-center">
        ...
        <div className="mx-[10%] w-[80%] self-center flex flex-col items-center justify-center gap-10 mb-10">
          <div className="md:flex md:flex-row flex-col w-full items-center justify-between">
            ...
            <button
              ...
              className="w-fit bg-yellow-500 hover:bg-yellow-600 transition-all ease-in-out duration-300 rounded py-2 px-4 font-semibold text-lg lg:mt-0 mt-10 cursor-pointer"
            >
              Create New Course
            </button>
            </center>
