...
const CreateCourse = () => {
  ...
  return (
    <HomeLayout>
      <div className="flex items-center justify-center min-h-[90vh] bg-gray-600">
        {/* card for creating the new card */}
        <form
          onSubmit={handleFormSubmit}
          className="flex flex-col justify-center gap-5 rounded-lg p-4 text-white w-[700px] h-[450px] my-10 shadow-[0_0_10px_black] relative bg-gray-800"
        >
          <Link
            to={"/admin/dashboard"}
